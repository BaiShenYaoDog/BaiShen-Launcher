...
import static cn.ChengZhiYa.BaiShenLauncher.ui.FXUtils.jfxListCellFactory;
import static cn.ChengZhiYa.BaiShenLauncher.ui.FXUtils.stringConverter;
import static cn.ChengZhiYa.BaiShenLauncher.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE;
import static cn.ChengZhiYa.BaiShenLauncher.ui.export.ModpackTypeSelectionPage.MODPACK_TYPE_SERVER;
...
public final class ModpackInfoPage extends Control implements WizardPage {
    ...
    public ModpackInfoPage(WizardController controller, HMCLGameRepository gameRepository, String version) {
        ...
        this.options = Lang.tryCast(controller.getSettings().get(MODPACK_INFO_OPTION), ModpackExportInfo.Options.class)
...

            {
...

                {
...

                    {
                        ...
                        pane.addRow(rowIndex++, new Label(I18n.i18n("modpack.name")), txtModpackName);
                        ...
                        pane.addRow(rowIndex++, new Label(I18n.i18n("archive.author")), txtModpackAuthor);
                        ...
                        pane.addRow(rowIndex++, new Label(I18n.i18n("archive.version")), txtModpackVersion);
                        ...
                        if (skinnable.options.isRequireFileApi()) {
                            ...
                            pane.addRow(rowIndex++, new Label(I18n.i18n("modpack.file_api")), txtModpackFileApi);
                        }
                        ...
                        if (skinnable.options.isRequireLaunchArguments()) {
                            ...
                            pane.addRow(rowIndex++, new Label(I18n.i18n("settings.advanced.minecraft_arguments")), txtLaunchArguments);
                        }
                        ...
                        if (skinnable.options.isRequireJavaArguments()) {
                            ...
                            pane.addRow(rowIndex++, new Label(I18n.i18n("settings.advanced.jvm_args")), txtJavaArguments);
                        }
                        ...
                        if (skinnable.options.isRequireUrl()) {
                            ...
                            pane.addRow(rowIndex++, new Label(I18n.i18n("modpack.origin.url")), txtModpackUrl);
                        }
                        ...
                        if (skinnable.options.isRequireOrigins()) {
                            ...
                            txtMcbbs.getValidators().add(new NumberValidator(I18n.i18n("input.number"), true));
                            txtMcbbs.textProperty().bindBidirectional(skinnable.mcbbsThreadId);
                            validatingFields.add(txtMcbbs);
                            pane.addRow(rowIndex++, new Label(I18n.i18n("modpack.origin.mcbbs")), txtMcbbs);
                        }
                    ...
                    if (skinnable.options.isRequireMinMemory()) {
...

                        {
                            ...
                            txtMinMemory.getValidators().add(new NumberValidator(I18n.i18n("input.number"), false));
...

                    {
                        ...
                        pane.getChildren().setAll(new Label(I18n.i18n("modpack.desc")), area);
                        list.getContent().add(pane);
                    }
                    ...
                    if (skinnable.options.isRequireForceUpdate()) {
                        BorderPane pane = new BorderPane();
                        pane.setLeft(new Label(I18n.i18n("modpack.wizard.step.initialization.force_update")));
                        list.getContent().add(pane);
                    ...
                    {
                        BorderPane pane = new BorderPane();
                        pane.setLeft(new Label(I18n.i18n("modpack.wizard.step.initialization.include_launcher")));
                        list.getContent().add(pane);
