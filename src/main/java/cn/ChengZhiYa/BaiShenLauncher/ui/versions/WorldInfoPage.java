...
import cn.ChengZhiYa.BaiShenLauncher.ui.construct.DoubleValidator;
import cn.ChengZhiYa.BaiShenLauncher.ui.construct.NumberValidator;
...
public final class WorldInfoPage extends StackPane implements DecoratorPage {
    ...
    public WorldInfoPage(World world) throws IOException {
        ...
        stateProperty.set(State.fromTitle(I18n.i18n("world.info.title", world.getWorldName())));
        ...
        ComponentList basicInfo = new ComponentList();
        {
            ...
            {
                Label label = new Label(I18n.i18n("world.info.game_version"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.random_seed"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.last_played"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.time"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.difficulty"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            rootPane.getChildren().addAll(ComponentList.createComponentListTitle(I18n.i18n("world.info.basic")), basicInfo);
        }
        ...
        if (playerTag instanceof CompoundTag) {
            ...
            {
                Label label = new Label(I18n.i18n("world.info.player.location"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.player.last_death_location"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.player.spawn"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.player.game_type"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.player.health"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.player.food_level"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            {
                Label label = new Label(I18n.i18n("world.info.player.xp_level"));
                BorderPane.setAlignment(label, Pos.CENTER_LEFT);
            ...
            rootPane.getChildren().addAll(ComponentList.createComponentListTitle(I18n.i18n("world.info.player")), playerInfo);
        }
    }

    private void saveLevelDat() {
        Logging.LOG.info("Saving level.dat of world " + world.getWorldName());
        try {
            this.world.writeLevelDat(levelDat);
        } catch (IOException e) {
            Logging.LOG.log(Level.WARNING, "Failed to save level.dat of world " + world.getWorldName(), e);
        }
    }
