...
import cn.ChengZhiYa.BaiShenLauncher.ui.download.UpdateInstallerWizardProvider;
    ...
    private class InstallerListPageSkin extends ToolbarListPageSkin<InstallerListPage> {
        ...
        protected List<Node> initializeToolbar(InstallerListPage skinnable) {
            return Collections.singletonList(
                    createToolbarButton2(I18n.i18n("install.installer.install_offline"), SVG::plus, skinnable::installOffline));
        }
    }
}
