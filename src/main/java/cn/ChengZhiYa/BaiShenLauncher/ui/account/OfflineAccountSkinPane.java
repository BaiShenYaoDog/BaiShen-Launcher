...
import cn.ChengZhiYa.BaiShenLauncher.auth.offline.Skin;
...
public class OfflineAccountSkinPane extends StackPane {
    ...
    public OfflineAccountSkinPane(OfflineAccount account) {
        ...
        layout.setHeading(new Label(I18n.i18n("account.skin")));
        ...
        cslApiField.setPromptText(I18n.i18n("account.skin.type.csl_api.location.hint"));
        cslApiField.setValidators(new URLValidator());

        skinItem.loadChildren(Arrays.asList(
                new MultiFileItem.Option<>(I18n.i18n("message.default"), Skin.Type.DEFAULT),
                new MultiFileItem.Option<>("Steve", Skin.Type.STEVE),
                new MultiFileItem.Option<>("Alex", Skin.Type.ALEX),
                new MultiFileItem.Option<>(I18n.i18n("account.skin.type.local_file"), Skin.Type.LOCAL_FILE),
                new MultiFileItem.Option<>("LittleSkin", Skin.Type.LITTLE_SKIN),
                new MultiFileItem.Option<>(I18n.i18n("account.skin.type.csl_api"), Skin.Type.CUSTOM_SKIN_LOADER_API)
        ));
        ...
        FXUtils.onChangeAndOperate(skinItem.selectedDataProperty(), selectedData -> {
            ...
            switch (selectedData) {
                ...
                case LITTLE_SKIN:
                    ...
                    break;
                case LOCAL_FILE:
                    gridPane.addRow(0, new Label(I18n.i18n("account.skin.model")), modelCombobox);
                    gridPane.addRow(1, new Label(I18n.i18n("account.skin")), skinSelector);
                    gridPane.addRow(2, new Label(I18n.i18n("account.cape")), capeSelector);
                    break;
                case CUSTOM_SKIN_LOADER_API:
                    gridPane.addRow(0, new Label(I18n.i18n("account.skin.type.csl_api.location")), cslApiField);
                    break;
            }
