...
import cn.ChengZhiYa.BaiShenLauncher.ui.construct.ClassTitle;
...
public class AccountListPage extends DecoratorAnimatedPage implements DecoratorPage {
    ...
    public AccountListPage() {
        ...
        selectedAccount = ExtendedProperties.createSelectedItemPropertyFor(items, Account.class);
    }
        ...
        public AccountListPageSkin(AccountListPage skinnable) {
...

            {
                VBox boxMethods = new VBox();
                {
                    ...
                    mojangItem.setTitle(I18n.i18n("account.methods.yggdrasil"));
                    ...
                    authServerItems = MappedObservableList.create(skinnable.authServersProperty(), server -> {
                        ...
                        try {
                            ...
                            Logging.LOG.log(Level.WARNING, "Unparsable authlib-injector server url " + server.getUrl(), e);
                        }
